...
;----------------------------------------------------------------------------
flag        DB  0
high_Y      DB  15	; координаты окна
left_X      DB  05	; координаты окна
low_Y       DB  23	; координаты окна
right_X     DB  23	; координаты окна
;
page_num    DB  0
coord_Y     DB  20	; Y координата сообщения в окне
coord_X     DB  07	; X координата сообщения в окне
SIZE		DW	12
BUFFER			DB	'Hello world!'	; сообщение выводимое в окно
;============================================================================
new_09h proc far
;
    pushf
...
check_install:
        mov AX,0B700h   ; AH=0B7h номер процесса B7h
...
; ------------------ Выгрузка -----------------------------------------------
 uninstall:
        mov AX,0B701h  ; AH=0B7h номер процесса B7h, подфункция 01h-выгрузка
        int 2Fh             ; мультиплексное прерывание
        cmp AL,0F0h
        je  not_sucsess
        cmp AL,0Fh
